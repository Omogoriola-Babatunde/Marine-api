...
<body style="font-family: Arial, sans-serif; padding: 20px;">
    <h2 style="text-align: center;">Certificate of Insurance</h1>
    <h3 style="text-align: center;">Marine Cargo Insurance</h2>
    ...
    const filePath = `certificate-${policy.policyNumber}.pdf`;
